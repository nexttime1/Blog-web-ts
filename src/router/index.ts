        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () =>
                import("../views/admin/user_center/user_add_article_list.vue"),
            },
            {
              path: "collects",
              name: "collects",
              ...
              component: () =>
                import("../views/admin/user_center/user_collects_list.vue"),
            },
            {
              path: "messages",
              name: "messages",
              ...
              component: () =>
                import("../views/admin/user_center/user_message_list.vue"),
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  component: () =>
                    import("../views/admin/big_model/options/reply_option.vue"),
                },
              ],
            },
            {
              ...
              component: () =>
                import("../views/admin/big_model/chat_role/index.vue"),
              ...
              children: [
                {
                  ...
                  component: () =>
                    import("../views/admin/big_model/chat_role/role_tag.vue"),
                },
                {
                  path: "role_list",
                  name: "role_list",
                  ...
                  component: () =>
                    import("../views/admin/big_model/chat_role/role_list.vue"),
                },
              ],
            },
            {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () =>
                import("../views/admin/system/feedback_list.vue"),
            },
            {
              path: "promotion_list",
              name: "promotion_list",
              ...
              component: () =>
                import("../views/admin/system/promotion_list.vue"),
            },
            {
              path: "log_list",
              name: "log_list",
